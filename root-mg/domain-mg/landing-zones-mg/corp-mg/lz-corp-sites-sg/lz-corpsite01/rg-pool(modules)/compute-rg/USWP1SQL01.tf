...
#Change gallery app to SQL Server Managment Server
...
module "SQL-DB-VM" {
  ...
  #version = "0.17.0
  #https://github.com/Azure/terraform-azurerm-avm-res-compute-virtualmachine/tree/main/examples/windows_w_gallery_application
